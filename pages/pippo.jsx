      ...
      <div>
        <ul>
          {data.films.map((film, index) => {
            console.log("inizia", index);
            return (
              <li key={film.id} className="text-2xl font-semibold">{film.title}</li>
            );
          })}
        </ul>
      </div>
